...
## Generating
These commands are ment to be issued from the project root directory with the [package.json](../package.json) file that contains the commands outlined below.
