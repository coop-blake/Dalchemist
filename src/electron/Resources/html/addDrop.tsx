...
window.electron.ipcRenderer.on(
  ...
  (event, lastAddDropLastRefresh: number) => {
...
window.electron.ipcRenderer.on(
  ...
  (event, newItemsInInventoryArray: Array<[NewItemEntry, InventoryEntry]>) => {
...
window.electron.ipcRenderer.on(
  ...
  (event, changeItemsArray: Array<AttributeChangeEntry>) => {
...
window.electron.ipcRenderer.on(
  "priceUpdates",
  (event, priceChangeItemsArray: Array<AttributeChangeEntry>) => {
    // eslint-disable-next-line no-console
...
const redraw = function () {
  onReady(() => {
    ...
    newItemsReceived &&
    changeItemsReceived &&
    newItemsInInventoryReceived &&
    priceChangeItemsReceived
      ? hide("loadingDiv")
      : show("loadingDiv");
  });
};
